...
- https://github.com/cybergarage/Concord-go/blob/main/Concord/plugins/query/sql/type.go[plugins.query.sql.NewDocumentElementTypeFrom()]
- https://github.com/cybergarage/Concord-go/blob/main/Concord/plugins/query/mongo/encoder.go[plugins.query.mongo.BSONEncoder::EncodeBSON()]
...
- https://github.com/cybergarage/Concord-go/blob/main/Concord/plugins/coder/key/tuple/coder.go[plugins.coder.key.tuple.Coder::EncodeKey()]
...
- https://github.com/cybergarage/Concord-go/blob/main/Concord/plugins/coder/document/cbor/coder.go[plugins.coder.document.cbor.Coder::EncodeDocument()]
